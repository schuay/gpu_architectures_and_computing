...
#define UNTIL_TEST(name, flhs, frhs, fexpected) \
START_TEST(name) \
{ \
    sigpt_t *a, *b, *c; \
 \
...
UNTIL_TEST(test_sig1, "sig01.trace", "sig02.trace", "until_sig01_sig02.breach.trace")
UNTIL_TEST(test_sig2, "sig03.trace", "sig04.trace", "until_sig03_sig04.breach.trace")
