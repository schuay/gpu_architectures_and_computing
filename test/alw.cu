...
#define ALW_TEST(name, fin, fexpected) \
START_TEST(name) \
{ \
    sigpt_t *in, *out; \
 \
...
ALW_TEST(test_sig1, "sig05.trace", "alw_sig05.breach.trace")
ALW_TEST(test_sig2, "sig06.trace", "alw_sig06.breach.trace")
