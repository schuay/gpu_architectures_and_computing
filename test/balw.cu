...
#define BALW_TEST(name, s, t, fin, fexpected) \
START_TEST(name) \
{ \
    sigpt_t *in, *out; \
 \
 ...
 \
    ...
    int nout; \
 \
    stl_balw(&vin[0], vin.size(), s, t, &vout, &nout); \
 \
...
START_TEST(test_sanity)
{
    ...
    stl_balw(&in[0], NITEMS, 5, 10, &out, &nout);
...
BALW_TEST(test_sig1, 5, 10, "sig05.trace", "balw_5_10_sig05.breach.trace")
BALW_TEST(test_sig2, 5, 10, "sig06.trace", "balw_5_10_sig06.breach.trace")
